...
namespace tempo::univariate {
     ...
     * @tparam ForwardIterator  Type of the ForwardIterator representing the database
    ...
    [[nodiscard]] std::vector<LabelType> nn1(
        ...
        static_assert(
                stassert::is_iterator_value_type<TSeries<FloatType, LabelType>, ForwardIterator>,
