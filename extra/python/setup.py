...
setup(
    ...
    description="Monash Time Series Classification library - python bindings",
    ext_modules=[CMakeExtension("pytempo", sourcedir, target="pytempo")],
