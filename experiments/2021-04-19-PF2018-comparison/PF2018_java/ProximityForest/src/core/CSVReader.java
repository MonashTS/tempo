...
public class CSVReader {
	...
	public final static String str_pat = "^\\s*(%|@)|^\\s*$";
	public final static Pattern pat = Pattern.compile(str_pat);
...
//	            System.out.println("Line " + lineNumberReader.getLineNumber() + ": " + line);
            ...
            if (hasHeader) {
                //number of rows;
                file_info[0] = nblines == 0 ? nblines : nblines - 1;
            } else {
                //number of rows;
                file_info[0] = nblines;
            }
    ...
    public static ListDataset readCSVToListDataset(String fileName, boolean hasHeader, boolean targetColumnIsFirst, String separator) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
            ...
            while ((line = br.readLine()) != null) {
            	...
            	if(pat.matcher(line).lookingAt()) { continue;}
